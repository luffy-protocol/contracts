...
contract LuffyCrosschain is Predictions{
    ...
    constructor(ConstructorParams memory _params) Predictions(_params.ccipRouter, _params.usdcToken, _params.linkToken, _params.priceFeedAddresses) {
    ...
    function _sendMessagePayNative(uint256 _fee, bytes memory _data) internal returns (bytes32 messageId)
    {
        ...
        IERC20(usdcToken).approve(address(router), _fee);
